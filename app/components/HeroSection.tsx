...
export default function HeroSection() {
  ...
  return (
    ...
    >
      {/* Floating orbs */}
      <div className="absolute top-[15%] left-[10%] w-72 h-72 rounded-full bg-accent-primary/10 blur-[100px] animate-float z-[1]" />
      <div className="absolute bottom-[20%] right-[15%] w-96 h-96 rounded-full bg-accent-secondary/8 blur-[120px] animate-float-delay-1 z-[1]" />
      <div className="absolute top-[40%] right-[30%] w-48 h-48 rounded-full bg-accent-tertiary/6 blur-[80px] animate-float-delay-2 z-[1]" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        {/* Main heading */}
        <h1
          className="animate-fade-in-up delay-200 text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black leading-[1.05] tracking-tight mb-8"
          style={{ opacity: 0 }}
        >
          Experience{" "}
        ...
        {/* Subtitle */}
        <p
          className="animate-fade-in-up delay-400 text-lg sm:text-xl md:text-2xl text-text-secondary max-w-2xl mx-auto mb-10 leading-relaxed"
          style={{ opacity: 0 }}
        >
        ...
        <div
          ...
          style={{ opacity: 0 }}
        >
          <a href="#showcase" className="btn-primary text-base px-8 py-4" id="hero-cta-primary">
            <span>View 3D Object</span>
            <span className="text-lg">↓</span>
          </a>
          <a href="#contact" className="btn-secondary text-base px-8 py-4" id="hero-cta-secondary">
            Get in Touch
          </a>
        </div>
      </div>
